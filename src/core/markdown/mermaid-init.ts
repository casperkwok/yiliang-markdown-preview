...
const mermaidModule = (mermaid as unknown as { default?: MermaidModule }).default || (mermaid as unknown as MermaidModule);
...
\`\`\``
        ...
        try {
          ...
          const { svg } = await mermaidModule.render(id, finalDefinition)
